        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-center" style="height: 100vh;">
                <div class="width">
                    ...
                    <form class="login-form " onsubmit="admin() ; return false" >
                        <div class="borders">
                            <p class="head">login</p>

                             <label for="name">username</label><br>
                             <input type="text" class="log form-input" id="user" placeholder="create your username"><br><br>

                             <label for="name">Password</label><br>
                             <input type="password" class="log form-input" id="password-1"  placeholder="create your password"><br><br>
